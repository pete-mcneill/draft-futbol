...
Future<List<LeagueStanding>> getStandings(String? gameweek, String seasonId) async {
    ...
    for (var i = 0; i < standings.length; i++) {
      ...
      LeagueStanding _standing = LeagueStanding.fromFirestoreJson(standing, teamUuid);
  ...
  Future<Map<String, dynamic>?> getTeamUuid(String id) async {
    final teamIds = await FirebaseFirestore.instance.collection("draft_teams").where("uuid", isEqualTo: id).get();
