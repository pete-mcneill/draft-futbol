...
class CupFixtureSummary extends ConsumerWidget {
  ...
  getTeamSummaryStats(
      DraftTeam team, Map<int, DraftPlayer> players, int gameweek) {
    int goals = 0;
    int assists = 0;
    int cleanSheets = 0;
    int bonusPoints = 0;
  ...
  getMatchSummary(DraftTeam homeTeam, DraftTeam awayTeam,
    ...
    String topPoints = '';
    DraftPlayer topPlayer;
    var homeStats = getTeamSummaryStats(homeTeam, players, gameweek);
    var awayStats = getTeamSummaryStats(awayTeam, players, gameweek);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final headToHeadScreenController =
        ref.watch(headToHeadScreenControllerProvider.notifier);
