...
for team in teams:
    r = requests.get(f'https://fantasy.premierleague.com/dist/img/shirts/standard/shirt_{team["code"]}-110.webp', stream=True)
    if r.status_code == 200:
        with open(f'./assets/images/kits/{team["code"]}-outfield.png', 'wb') as f:
